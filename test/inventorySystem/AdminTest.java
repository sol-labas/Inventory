...
public class AdminTest {
    ...
    /**
     * Test of canAddData method, of class Admin.
     */
    @Test
    public void testCanAddData() {
        System.out.println("canAddData");
        Admin instance = new Admin(1, "Vasya");
    ...
    /**
     * Test of canReport method, of class Admin.
     */
    @Test
    public void testCanReport() {
        System.out.println("canReport");
        Admin instance = new Admin(1, "Kolya");
        boolean expResult = true;
    ...
    public void testGetName() {
        ...
        Admin instance = new Admin(2, "Katya");
    ...
    public void testSetName() {
        ...
        String name = "Polya";
        Admin instance = new Admin(3, "Maya");
